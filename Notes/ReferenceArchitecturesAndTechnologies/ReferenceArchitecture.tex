...
\section{Reference Frameworks}\label{sec: RefFrameworks}
	...
	The use of Object-relational mapper in Django's MVC is described in \ref{subsec: ORM}. Django processes HTTP requests with a web templating system and regular-expression URL control (View and Controller).
	\\ \\
