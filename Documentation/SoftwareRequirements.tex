...
\begin{document}
	...
	\section{Functional Requirements and Application Design}\label{sec:functional}
		\subsection{Use Case Prioritization}\label{subsec:usecasepriorotization}
			\subsubsection{Paper System}\label{subsubsec:paper}
				...
				\begin{itemize}
					...
					\begin{itemize}
						...
						\item \textbf{Post-conditions:}
						\begin{itemize}
							\item There should be an ordered list of unlimited size associated with the paper consisting of the details of the author and co-authors.
					...
					\item \textbf{xxx:} \hfill \textit{Priority: xxx}
					\begin{itemize}
						\item
						\item \textbf{Pre-conditions:}
						\begin{itemize}
