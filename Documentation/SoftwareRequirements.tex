...
\begin{document}
	...
	\section{Functional Requirements and Application Design}\label{sec:functional}
		\subsection{Use Case Prioritization}\label{subsec:usecasepriorotization}
			\begin{description}
			  \item[Critical:] Use cases that are absolutely essential 
			  	\begin{itemize}
			  		\item 
			  		\item
			  	\end{itemize}
			  \item[Important:] Use cases that contribute significantly,
			   but the system can function without
			  	\begin{itemize}
			  		\item 
			  		\item
			  	\end{itemize}
			  \item[Nice-to-Have:] Use cases that contribute insignificantly to the system
			  	\begin{itemize}
			  		\item 
			  		\item
			  	\end{itemize}
		...
		The Domain model includes the UML diagrams in terms of Class diagrams for the current system.\\ Each model includes the objects and attributes of that specific class and any relationships associated with that class.\\
			%\begin{figure}[h]
			%\includegraphics[width=4in]{imagename}
			%\caption{Figure information}
			%\end
