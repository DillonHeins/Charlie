...
\begin{document}
	...
	\section{Functional Requirements and Application Design}\label{sec:functional}
		...
		The Domain model includes the UML diagrams in terms of Class diagrams for the current system. \\ 
		Each model includes the objects and attributes of that specific class and any relationships associated with that class.\\
			%\begin{figure}[h]
			%\includegraphics[width=4in]{imagename}
			%\caption{Figure information}
			%\end
